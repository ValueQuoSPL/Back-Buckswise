...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("Buckswise_Back_End");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("Buckswise_Back_End");
        ...
        config.getMapConfigs().put("com.valuequo.buckswise.domain.*", initializeDomainMapConfig(jHipsterProperties));
