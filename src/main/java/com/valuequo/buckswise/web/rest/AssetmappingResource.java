...
//    }
//    
    @GetMapping("/getbyuid/{uid}/{goalid}")
    @Timed
    public List<Assetmapping> getChit1(@PathVariable Long uid, @PathVariable int goalid){
    	return assetmappingService.getAssetByUid(uid, goalid);
    } 
