...
public class LoananddebtService {
	...
	public Loananddebt save(int userid, String amount, String appName, String checkType, String itype, String ldate,
			String lenderName, String ltype, String rdate, String roi, String tenure, String Outstandingprincipal) {
		
		Loananddebt ld = new Loananddebt( userid, amount, appName, checkType, itype, ldate, lenderName, ltype, rdate, roi, tenure, Outstandingprincipal);
		ld.setUserid(userid);
		ld.setAmount(amount);
		...
		ld.setRoi(roi);
		ld.setTenure(tenure);
		ld.setOutstandingpricipal(Outstandingprincipal);
